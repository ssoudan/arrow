...
// arrow.core.OptionMonadErrorInstanceImplicits$instance$1@6a8ca87c
```

```kotlin
monadError<ForTry, Throwable>()
// arrow.data.TryMonadErrorInstanceImplicits$instance$1@537e8ce3
```

```kotlin
monadError<EitherPartialOf<NukeException>, NukeException>()
// arrow.core.EitherMonadErrorInstanceImplicits$instance$1@4882c984
```
